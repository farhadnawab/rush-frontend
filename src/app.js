...
$(() => {
  ...
  // mapping marker html
  markers.map((val) => new mapboxgl.Marker({ element: val }))
  .forEach((e, index) => {
    const coord = JSON.parse(markers[index].getAttribute("data-coord"));
